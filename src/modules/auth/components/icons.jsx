export function TeaCupIcon(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <path
        d="M8 7h13v10.5A5.5 5.5 0 0 1 15.5 23h-2A5.5 5.5 0 0 1 8 17.5V7Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="2.4"
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M9 27h14" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" />
    </svg>
  );
}
...
export function GearIcon(props) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm8 3.5-2.1-.8a6.4 6.4 0 0 0-.5-1.2l.9-2-2.3-2.3-2 .9c-.4-.2-.8-.4-1.2-.5L12 4H8.8L8 6.1c-.4.1-.8.3-1.2.5l-2-.9-2.3 2.3.9 2c-.2.4-.4.8-.5 1.2L1 12v3.2l2.1.8c.1.4.3.8.5 1.2l-.9 2 2.3 2.3 2-.9c.4.2.8.4 1.2.5l.8 2.1H12"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="m13.5 6 4.5 4.5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
